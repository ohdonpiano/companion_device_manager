...
abstract class CompanionDeviceManagerPlatform extends PlatformInterface {
  ...
  static CompanionDeviceManagerPlatform _instance = MethodChannelCompanionDeviceManager();
  ...
  Future<void> registerBackgroundCallback(
    ...
    throw UnimplementedError('registerBackgroundCallback() has not been implemented.');
  }

  Future<void> clearBackgroundCallback() {
    throw UnimplementedError('clearBackgroundCallback() has not been implemented.');
  }
